...
#ifndef GOTOPERCENTNODE_H_
#define GOTOPERCENTNODE_H_
...
class GotoPercentNode: public naviengine::VirtualMenuNode
{
public:
    GotoPercentNode(int max, DaisyNavi*);
